...
from model import GPTConfig, GPT, BN_init
...
wandb_run_name = 'gpt2supertiny' # 'run' + str(time.time())
# data
dataset = 'openwebtext'
...
# initialize the model with BatchNorm statistics
if bn_init and init_from == 'scratch':
